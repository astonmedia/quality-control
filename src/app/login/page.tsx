...
const Login = () => {
  ...
  return (
    <div className="flex flex-row min-h-screen justify-center items-center">
      <div className="bg-signet_yellow lg:w-6/12 md:w-7/12 w-8/12 shadow-3xl rounded-xl">
        ...
        <form onSubmit={(e) => onSubmit(e)} className="p-12 md:p-24">
          <div className="text-black flex justify-center mx-auto mb-6">
            <h1 className="text-2xl font-bold">Signet Quality System</h1>
          </div>
          <div className="flex items-center text-lg mb-6 md:mb-8 text-black">
